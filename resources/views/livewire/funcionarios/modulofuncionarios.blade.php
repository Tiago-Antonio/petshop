    ...
    <div class="max-w-screen-xl mx-auto gap-4 mt-8 px-8 ">
        <div class=" grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 items-center ">
            ...
            <div class=" grid place-items-end">
                <button type="button" wire:click='abrirModal'  class=" text-white px-8 py-2 rounded-lg bg-teal-700 hover:bg-teal-900 transition-all ease-in-out duration-300">
                        ...
                        <div class="relative">
                            ...
                            <div class="absolute top-0 right-0 w-48 bg-white shadow-lg rounded-lg border border-gray-200 z-30 py-4">
                                ...
                                <div class="flex flex-col px-4  gap-2">
                                    ...
                                    <button type="button" wire:click='confirmarExclusao({{ $item["id"] }})' class="flex items-center gap-2 text-sm text-red-600 hover:text-red-800 transition">
                            ...
                            <div  class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                                <div class="bg-white rounded-lg p-6 shadow-xl">
                                    ...
                                    <div class="flex justify-end gap-4">
                                        <button wire:click='confirmarExclusao({{ $item["id"] }})' class="px-4 py-2 text-gray-600 hover:text-gray-800">Cancelar</button>
