<section class="min-h-screen flex items-center justify-center bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-blue-200 via-blue-400 to-indigo-600">
    ...
    <div class="w-full max-w-3xl max-w-5xl bg-white rounded-xl shadow-2xl flex overflow-hidden h-[600px]">
        ...
        <div class="w-1/2 py-10 px-10 flex flex-col justify-center">
            ...
            <h2 class="text-4xl font-bold text-gray-600 mb-2 tracking-wide drop-shadow-md">Bem-vindo<span class="text-blue-500">!</span></h2>
