    ...
    <div class="grid grid-rows-1 md:grid-rows-5 2xl:grid-rows-3 max-w-screen-xl mx-auto gap-6 py-4 px-4 2xl:px-8">
        ...
        <div class="grid gap-2 2xl:gap-4 h-full">
            <div class="h-full grid place-items-center">
                <h1 class="text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-gray-800">{{ $this->usuario_name }}, Bem vindo a sua
                    ferramenta de Gestão</h1>
            </div>
            <div class=" grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {{-- Funcionarios --}}
                <div
                    class="cursor-pointer shadow-lg hover:shadow-xl transition-all h-full bg-white rounded-3xl grid place-items-center p-4 bg-gradient-to-r from-blue-500 to-indigo-600 text-white">
                ...
                {{-- Clientes --}}
                <div
                    class="cursor-pointer shadow-lg hover:shadow-xl transition-all h-full bg-white rounded-3xl grid place-items-center p-4 bg-gradient-to-r from-green-400 to-teal-500 text-white">
                ...
                {{-- Fornecedores --}}
                <div
                    class="cursor-pointer shadow-lg hover:shadow-xl transition-all h-full bg-white rounded-3xl grid place-items-center p-4  bg-gradient-to-r from-yellow-500 to-orange-500 text-white">
                    <a href="{{ route('clientes') }}" wire:navigate class="grid place-items-center">
                        <div class="flex gap-2 2xl:grid place-items-center">
                ...
                {{-- Produtos --}}
                <div
                    class="cursor-pointer shadow-lg hover:shadow-xl transition-all h-full bg-white rounded-3xl grid place-items-center p-4 bg-gradient-to-r from-pink-500 to-red-500 text-white">
        ...
        <div class=" grid grid-cols-1 lg:grid-cols-4 gap-4">
            ...
            <div class="h-full flex-1 md:col-span-3 shadow-lg bg-white rounded-3xl p-4">
                ...
                <div class="mt-4 overflow-x-auto rounded-lg">
                    <table class="md:min-w-full table-auto text-sm text-left border border-gray-200">
                        <thead class="bg-emerald-100 text-emerald-900">
                            <tr>
                                <th class="2xl:px-4 py-3 font-semibold md:uppercase md:tracking-wide text-xs md:text-base">Produto</th>
                                <th class="2xl:px-4 py-3 font-semibold md:uppercase md:tracking-wide text-xs md:text-base">Estoque Atual</th>
                                <th class="2xl:px-4 py-3 font-semibold md:uppercase md:tracking-wide text-xs md:text-base">Estoque Mínimo</th>
                                <th class="2xl:px-4 py-3 font-semibold md:uppercase md:tracking-wide text-xs md:text-base">Atualizado em</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-200 bg-white">
                            @forelse($min_produtos as $produto)
                                <tr class="hover:bg-emerald-50 transition">
                                    ...
                                    <td class="2xl:px-4 py-3 font-medium text-red-600">{{ $produto['current_stock'] }}</td>
