    ...
    <div class=" max-w-screen-xl mx-auto grid grid-cols-4 gap-4 mt-4 px-8  ">
                ...
                @if ($show == true)
                    <div class=" h-screen w-screen z-50 fixed grid place-items-center left-0 top-0"
                        ...
                        <form wire:submit.prevent='CadastrarProduto'
                            ...
                            <p class="text-center font-bold text-2xl text-gray-700 mb-4">Adicionar Produtos</p>
        ...
        <div x-data="{ open: false }" class="relative">
            ...
            <button @click="open = true"
                class="fixed  bottom-6 right-20 bg-indigo-600 text-white p-4 rounded-full shadow-lg z-40">
                                    ...
                                    <li wire:key='carrinho-{{ $index }}'
                                        ...
                                        <div class="flex items-center gap-1">
                                            ...
                                            <button wire:click="removerCarrinho({{ $item['id'] }})"
                                                class="bg-red-100 hover:bg-red-200 text-red-600 rounded-full w-6 h-6 flex items-center justify-center shadow transition">
                                                <i class="fa-solid fa-minus"></i>
                                            </button>

                                            <!-- Quantidade -->
                                            <span
                                                class="text-lg font-medium text-gray-800 min-w-[24px] text-center">{{ $item['quantidade'] }}</span>

                                            <!-- Botão de Adicionar -->
                                            <button wire:click="adicionarCarrinho({{ $item['id'] }})"
                                                class="bg-blue-100 hover:bg-blue-200 text-blue-600 rounded-full w-6 h-6 flex items-center justify-center shadow transition">
                                                <i class="fa-solid fa-plus"></i>
                                            </button>
                                        </div>
                                        <button wire:click="removerCarrinho({{ $item['id'] }})"
